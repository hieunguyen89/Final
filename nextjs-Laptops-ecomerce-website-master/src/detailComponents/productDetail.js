        ...
        <div className="cart-info">
          ...
          <div className="colors-wrap">
            ...
            <div className="colors">
              <div className="color black" style={{ background: "black" }} />
              <div className="color silver" style={{ background: "silver" }} />
              <div className="color pink" style={{ background: "pink" }} />
              <div className="color blue" style={{ background: "blue" }} />
            </div>
          </div>
          <div className="price">

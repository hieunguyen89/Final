  ...
  <div className="product">
    <div className="product-top">
      <div className="product-img">
        <img src={`/img/${product.img}.png`} alt="laptop" className="image-active" />
      </div>
      <div className="product-carousel">
        <div className="carousel-slide">
          {carousels.map((carousel, index) => (
            <div className="img-carousel" key={index}>
              <img src={`/img/${carousel.img}.png`} alt="laptop" className="image-right" />
            </div>
          ))}
        </div>
      </div>
    ...
    <div className="product-description">
      ...
      <div className="price">
        ...
        <span className="dis-count">-5%</span> <span className="net-price">$82.09</span>
      </div>
      <div className="time">
        {timeStamps.map((time, index) => (
          <div className="time-unit" key={index}>
            <div className={time.color ? "time-count time-active" : "time-count"}>{time.count}</div>
